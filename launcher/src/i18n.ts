...
const en = {
  ...
  mcpStepThreeBody: "Before creating the connector, enable Developer Mode in ChatGPT Settings. In ChatGPT Plugins, create a connector, choose Tunnel, select the tunnel you created, set Authentication to None, and name it exactly lca-token. Then verify the runtime.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  mcpStepThreeBody: "创建连接器前，先在 ChatGPT 设置中启用开发者模式。然后在 ChatGPT Plugins 中创建连接器，选择 Tunnel，选中刚创建的 Tunnel，将身份验证设为无，并将名称设为 lca-token。最后验证运行时。",
